...
export const MagicWandIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M5 3v4"></path><path d="M19 17v4"></path><path d="M3 5h4"></path><path d="M17 19h4"></path><path d="M16.4 8.6l1.4-1.4"></path><path d="M6.2 17.8l1.4-1.4"></path><path d="M8.6 6.2l-1.4 1.4"></path><path d="M17.8 17.8l-1.4-1.4"></path><path d="m12 2-2.8 5.6L4 10l5.6 2.8L12 22l2.8-5.6L20 14l-5.6-2.8Z"></path>
    </svg>
);
